  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
    ...
    function srcAppProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProfilePage = /*#__PURE__*/function () {
        function ProfilePage(navCtrl, Router, loadingCtrl, alertCtrl, ApiserviceService, storage) {
        ...
        _createClass(ProfilePage, [{
          ...
          value: function ionViewWillEnter() {
            ...
            this.storage.get('storage_poslogvendor').then(function (data) {
              ...
              _this.Storage.gender = data.data.gender;
              _this.Storage.email = data.data.email;
              _this.Storage.password = data.data.password;
            });
          }
        }, {
          key: "UpdateProfile",
