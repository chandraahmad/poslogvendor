...
const routes = [
    ...
    {
        path: 'updateprofile',
        loadChildren: () => Promise.all(/*! import() | updateprofile-updateprofile-module */[__webpack_require__.e("common"), __webpack_require__.e("updateprofile-updateprofile-module")]).then(__webpack_require__.bind(null, /*! ./updateprofile/updateprofile.module */ "./src/app/updateprofile/updateprofile.module.ts")).then(m => m.UpdateprofilePageModule)
    },
    {
        path: 'updatepassword',
        loadChildren: () => Promise.all(/*! import() | updatepassword-updatepassword-module */[__webpack_require__.e("common"), __webpack_require__.e("updatepassword-updatepassword-module")]).then(__webpack_require__.bind(null, /*! ./updatepassword/updatepassword.module */ "./src/app/updatepassword/updatepassword.module.ts")).then(m => m.UpdatepasswordPageModule)
    },
    {
        path: 'administrasi',
        loadChildren: () => Promise.all(/*! import() | administrasi-administrasi-module */[__webpack_require__.e("common"), __webpack_require__.e("administrasi-administrasi-module")]).then(__webpack_require__.bind(null, /*! ./administrasi/administrasi.module */ "./src/app/administrasi/administrasi.module.ts")).then(m => m.AdministrasiPageModule)
    },
    {
        path: 'document',
        loadChildren: () => Promise.all(/*! import() | document-document-module */[__webpack_require__.e("common"), __webpack_require__.e("document-document-module")]).then(__webpack_require__.bind(null, /*! ./document/document.module */ "./src/app/document/document.module.ts")).then(m => m.DocumentPageModule)
    },
];
...
/* harmony import */ var _ionic_native_file_opener_ngx__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @ionic-native/file-opener/ngx */ "./node_modules/@ionic-native/file-opener/__ivy_ngcc__/ngx/index.js");
...
/* harmony import */ var _ionic_native_base64_ngx__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ionic-native/base64/ngx */ "./node_modules/@ionic-native/base64/__ivy_ngcc__/ngx/index.js");
...
module.exports = __webpack_require__(/*! /Users/posindonesia/Documents/posindonesia/poslogvendor/Mobile/src/main.ts */"./src/main.ts");
